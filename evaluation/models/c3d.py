...
def _make_npz(path_npz, url, model):
    path_caffemodel = "/egr/research-actionlab/puyujian/PromptI2V/evaluation/store_pth/c3d_ucf101_finetune_whole_iter_20000"
    # path_caffemodel = "c3d_ucf101_finetune_whole_iter_20000"  # Check if the Caffe model file exists, if not, download it
